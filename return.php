...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_query = "UPDATE orders SET OrderStatus = 'Return Requested', ReturnReason = '$return_reason' WHERE OrderID = '$order_id' AND Email = '$Email'";
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Return request submitted successfully.'); window.location.href='orders.php';</script>";
    } else {
        echo "<script>alert('Error submitting return request: " . mysqli_error($conn) . "');</script>";
    }
}
