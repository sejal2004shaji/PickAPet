...
if (isset($_POST['submit'])) {
    ...
    if(move_uploaded_file($_FILES["media"]["tmp_name"], $targetFilePath)){
        ...
        $stmt = $conn->prepare("INSERT INTO pet_upload_requests (username, date, media, price, breed, pet_type) VALUES (?, ?, ?, ?, ?, 'cow')");
...
<body>
    <div class="form-container">
        ...
        <form action="cowsubmit.php" method="POST" enctype="multipart/form-data">
