...
$query = "SELECT media, pet_type, breed, price FROM pet_upload_requests WHERE pet_type = 'Rabbit' AND status = 1";
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                echo "<div class='pet-item'>
                        <img src='uploads/{$row['media']}' alt='Rabbit Image'>
